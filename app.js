...
function addTradingTypeRow(type = 'Spot', volume = '') {
    ...
    row.innerHTML = `
        <select class="form-select type-select" style="max-width: 150px;">
            <option value="Spot" ${type === 'Spot' ? 'selected' : ''}>Spot</option>
            <option value="Future" ${type === 'Future' ? 'selected' : ''}>Future</option>
            <option value="Convert" ${type === 'Convert' ? 'selected' : ''}>Convert</option>
            <option value="State" ${type === 'State' ? 'selected' : ''}>State</option>
            <option value="Earn" ${type === 'Earn' ? 'selected' : ''}>Earn</option>
            <option value="Tradfi" ${type === 'Tradfi' ? 'selected' : ''}>Tradfi</option>
            <option value="Watch" ${type === 'Watch' ? 'selected' : ''}>Watch</option>
        </select>
